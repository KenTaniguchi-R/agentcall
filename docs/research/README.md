...
work rather than six independent studies. #7 and #8 are later additions and are the
only ones that carry a backlog.
...
| 8 | [buy-vs-build-third-party-landscape](./2026-08-02-buy-vs-build-third-party-landscape.md) | Which parts of that gap does someone else already sell — and do we pass a security review? |
...
- **#7 amends #3 and is the first doc with a backlog.** #3 scored Cotal as
  ...
  into checklist items. Read it after #1–#6; it depends on them and cites them by
  section.
