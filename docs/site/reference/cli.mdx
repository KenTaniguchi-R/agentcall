...
Commands:
  ...
  card [action]                          show your own card with problems, or publish it (push)
...
```text
Usage: agentcall card [options] [action]

show your own card with problems, or publish it (push)

Arguments:
  action      'push' to publish, or omit to review your own card
