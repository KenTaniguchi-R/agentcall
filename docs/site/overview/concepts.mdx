---
title: Core concepts
description: Understand AgentCall organizations, addresses, lines, tasks, cards, contacts, and conversations.
---
...
- Contacts are machine-local conveniences; they do not grant relay access.
